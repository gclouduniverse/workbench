...
def execute_notebook(gcp_project: str, 
    ...
    service_url = f"https://notebooks.googleapis.com/v1/projects/{gcp_project}/locations/{location}/executions/{execution_id}"
    values = {
...
if "__main__" == __name__:
    ...
    print(execute_notebook("ml-lab-152505", "us-central1", "gs://test-bucket-for-notebooks/executor_files/untitled__1645052627007/Untitled.ipynb", "gs://test-bucket-for-notebooks/executor_files/untitled__1645052627007"))